  ...
  readonly experience: Experience[] = [
    {
      ...
      points: [
        ...
        'Implemented high-impact customer journeys including direct debit setup, estimated pricing flows, and WebView-based mobile app integration using Angular and NgRx.',
    ...
    },
    {
      ...
      points: [
        ...
        'Built end-to-end lending lifecycle features including document ingestion, credit decisioning status flows, and real-time journey analytics dashboards for bank advisors.',
    ...
    },
    {
      ...
      endDate: 'Oct 2022',
      points: [
        'Designed and validated a scalable micro frontend architecture using Nx monorepo tooling and Webpack Module Federation, enabling independently deployable Angular feature modules.',
      ],
    },
    {
